        ...
        <Prose>
          ...
          <div className="grid sm:grid-cols-3 gap-4 my-6">
            ...
            <div className="bg-white p-5 text-center border border-charcoal/8">
              ...
              <p className="text-sm text-smoke">Air circulation — don't smother the fire, feed it breath</p>
            </div>
          </div>
          ...
          <p>Tinder must be bone-dry, fine, and fibrous. If it doesn't crumble easily or feel papery, it's not ready.</p>
          <ul className="list-disc list-inside space-y-1 text-charcoal/80 ml-4">
            <li><strong>Birch bark</strong> — the gold standard. The oils make it burn even when damp. Peel thin strips.</li>
            <li><strong>Dried grass</strong> — bundle loosely, bird's-nest shape. Dead standing grass is better than ground-lying.</li>
          ...
          <h3 className="text-2xl font-serif font-semibold text-bark mt-8 mb-3">Kindling — Feeds the Infant Fire</h3>
