...
export default function Community() {
  return (
    <div>
      <PageHeader
        title="Community"
        subtitle="How to build cooperative systems where nobody has to be in charge"
      />

      <ContentSection>
        <Prose>
          <p className="text-xl text-charcoal/80 font-serif italic mb-8">
            Community is possible. Humans have lived cooperatively for most of our existence as a species. The harder part is doing it intentionally, in a culture that has spent three centuries training us away from it.
          </p>
          ...
          <p>
            A cooperative community is a set of agreements. Some are formal. Some are habits. All of them can be renegotiated. The point is that they exist. People have talked about them, written them down, and chosen them together.
          </p>
        </Prose>
      </ContentSection>
      ...
      <div className="bg-parchment py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-smoke mb-8">
            In 1948, B.F. Skinner published <em>Walden Two</em>, a novel about an intentional community designed using behavioral science. The book is imperfect. Some of its ideas feel controlling. But its core insight is sound: the systems we live inside shape how we behave. If we design better systems, we get better outcomes. Remove friction from cooperation. Add friction to exploitation.
          </p>

          <div className="grid md:grid-cols-2 gap-6">
            <InfoCard title="Shared Labor by Choice">
              <p>Everyone contributes. Nobody is assigned permanently to work they hate. Labor rotates. A credit system tracks hours so invisible work becomes visible. Cooking, cleaning, childcare, and maintenance count as much as building or growing.</p>
            </InfoCard>

            <InfoCard title="Small Scale Governance">
              <p>No president. No board. Decisions happen by consent, which differs from consensus. Consent means nobody has a principled objection. You don't have to love every decision. You have to be able to live with it. If you can't, you say so, and the group works it out.</p>
            </InfoCard>
          ...
          <Callout type="note">
            <p><strong>A note on Walden Two:</strong> Read it if you haven't. Read it critically. Skinner's fictional community has elements that feel paternalistic. The planners have too much power. The novel doesn't fully solve the problem of authority. But the question it asks remains worth asking: can we design a community that reduces unnecessary suffering? Take what works. Leave the rest.</p>
          </Callout>
        </div>
      </div>
      ...
      <ContentSection>
        ...
        <div className="space-y-8">
          ...
          <div className="border-l-4 border-charcoal pl-6">
            ...
            <p className="text-smoke">
              Conflicts will happen. They are data. The system needs a process: direct conversation first, mediation second, community discussion third. The goal is to prevent disagreement from becoming resentment. Name it early. Address it directly. Move on.
            </p>
          </div>
          ...
          <div className="border-l-4 border-charcoal pl-6">
            ...
            <p className="text-smoke">
              Consensus is a trap. It requires everyone to agree, which means one person can block anything. Consent based decision making is different: a proposal passes unless someone has a reasoned, principled objection. That means a specific concern that the proposal would cause harm, not a preference. This keeps things moving while protecting minority voices.
            </p>
          </div>
        </div>
      </ContentSection>
